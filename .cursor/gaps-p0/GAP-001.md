...
- [x] GAP-002 route audit linked as next step → [GAP-002.md](./GAP-002.md)
...
- Full IDOR route audit → [GAP-002.md](./GAP-002.md)
- Production HTTPS/deploy → [GAP-003.md](./GAP-003.md)
