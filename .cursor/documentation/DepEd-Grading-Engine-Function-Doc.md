...
| Component weights | WW/PT/QA % by grade band | `defaultWeights(gradeLevel)` in `transmutation.ts` |
...
Parsed from `classes.grade_level` string. **Configurable weights deferred** (GAP-103).
