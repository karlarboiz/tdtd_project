        ...
        {!eventId ? (
          ...
          <SkeletonStatus label="Loading score sheet" className="space-y-6">
            ...
            >
              ...
              <SkeletonBar className="mb-1 h-6 w-56" />
              <SkeletonBar className="h-3 w-48" />
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <ScoreRosterSkeleton rows={6} withCheckbox={false} />
            </div>
          </SkeletonStatus>
        ) : !event ? (
          <div className="mx-auto max-w-md rounded-2xl bg-white p-6 text-center shadow-sm">
          ...
          <>
            ...
            {students.length === 0 ? (
              <p className="mt-6 text-center text-slate-600">
                No students in this class. Add students under Classes &amp;
                Students.
              </p>
            ) : (
              <ContentReveal revealKey={eventId} className="mt-6">
